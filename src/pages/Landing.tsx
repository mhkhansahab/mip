...
const MetaMaskAuth = loadable(() => import('../components/MetaMaskAuth'));
const TimerLanding = loadable(() => import('../components/common/TimerLanding'));
const LandingItemGallery = loadable(() => import('../components/LandingItemGallery'));
const FreeKart = loadable(() => import('../components/Pass/FreeKart/FreeKart'));
const PremiumKart = loadable(() => import('../components/Pass/PremiumKart/PremiumKart'));
